...
function legacyTeam(id: string, name: string) {
  return {
    ...
    roster: [
      ...
      { id: `${id}-p2`, name: `Player 2`, positionalKey: "lineman" },
      { id: `${id}-p3`, name: `Player 3`, positionalKey: "lineman" },
      { id: `${id}-p4`, name: `Player 4`, positionalKey: "lineman" },
      { id: `${id}-p5`, name: `Player 5`, positionalKey: "lineman" },
      { id: `${id}-p6`, name: `Player 6`, positionalKey: "lineman" },
      { id: `${id}-p7`, name: `Player 7`, positionalKey: "lineman" },
      { id: `${id}-p8`, name: `Player 8`, positionalKey: "lineman" },
      { id: `${id}-p9`, name: `Player 9`, positionalKey: "lineman" },
      { id: `${id}-p10`, name: `Player 10`, positionalKey: "lineman" },
      { id: `${id}-p11`, name: `Player 11`, positionalKey: "lineman" },
    ],
