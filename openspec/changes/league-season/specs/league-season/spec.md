...
A started league detail MUST expose its fixtures. Each fixture has leagueId, round, homeTeamId, awayTeamId. Detail responses MUST return fixtures grouped by round (jornada) with home-vs-away labeled teams.
