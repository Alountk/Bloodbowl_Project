...
| Feature | Notas |
|---|---|
| **Histórico completo con replay / taxonomía amplia** | El modo en vivo (SSE, turnos, relojes, timeline) y los eventos de kickoff (Error costoso + Factor de aficionados, #100–#102) ya están en Completado; lo que queda es replay de partidos, taxonomía completa de eventos (intercepciones, skills, clima, resto de la tabla de kickoff), filtros y visualización pública — todo explícitamente fuera del alcance de MV-6. |
