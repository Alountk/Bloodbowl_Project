...
| Catálogo BB2025 = **31 razas / 163 posicionales** (Slann añadido), alineado con el reglamento BB2025 (composición, letras de acceso, skills BB2025 completas, nombres ES); el catálogo vive en JSON con validador y un scraper de referencia como fuente | #106, #107, directos a main |
...
| **Roster denso estilo libro**: tabla densa con progresión integrada (barra SPP segmentada, NI, skills con marcador de compra), modal de improve con selects filtrados por PE, renombrar jugadores, dorsal junto al puesto y stats de carrera (CAS/MVP) | directos a main |
...
| **Diseño match view v7 restaurado/validado** (header sticky 3 filas, timeline, cards de eventos con iconos SVG) y arranque de partido sin fecha acordada | #103 |
...
| Match view degradado vs. el mockup validado | Restauración y lock del diseño v7 (#103) |
